#' OCP-Nigeria cropping system productivity indicators
#' M. Walsh, June 2017
...
# Productivity grids
download("https://www.dropbox.com/s/2ial0d6p97wjrcg/OCP_npp.zip?raw=1", "OCP_npp.zip", mode="wb")
unzip("OCP_npp.zip", overwrite=T)
